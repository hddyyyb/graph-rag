...
---
### Day31 — Chunking System Redesign

Objective:
Upgrade chunking from naive splitting to structure-aware chunking.

Tasks:

- introduce ChunkerPort
- decouple chunking from IngestService
- implement FixedWindowChunker (baseline)
